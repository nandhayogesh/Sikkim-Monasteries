    ...
    <div className="min-h-screen pt-16">
      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <Button
          ...
          size="sm"
          onClick={() => navigate("/")}
          className="absolute top-6 left-6 bg-white/20 backdrop-blur-md border-white/30 text-white hover:bg-white/30"
        >
        ...
        <div className="absolute bottom-8 left-8 text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">{monastery.title}</h1>
          <div className="flex flex-wrap items-center gap-4 text-white/90">
            <div className="flex items-center space-x-2">
              <MapPin className="w-5 h-5" />
              <span className="text-lg">{monastery.location}</span>
            </div>
            <div className="flex items-center space-x-2">
              <Clock className="w-5 h-5" />
              <span className="text-lg">Est. {monastery.established}</span>
            </div>
            <div className="flex items-center space-x-2">
              <Mountain className="w-5 h-5" />
              <span className="text-lg">{monastery.altitude}</span>
            </div>
          </div>
        </div>
